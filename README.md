This is `ps gallery v3.3.12.`
    ...
    $ ps
    PID TTY          TIME CMD
    9260 pts/8    00:00:00 build.sh
    9264 pts/8    00:00:00 build.sh
    9265 pts/8    00:00:00 ps
    9266 pts/8    00:00:00 python3
    11146 pts/8    00:00:00 bash

    $ ps T
    PID TTY      STAT   TIME COMMAND
    9260 pts/8    S+     0:00 /bin/bash ./build.sh
    9264 pts/8    S+     0:00 /bin/bash ./build.sh
    9267 pts/8    R+     0:00 ps T
    9268 pts/8    R+     0:00 python3 /home/mdione/local/bin/indent 4 -
    ...
    5224 tty7     Ssl+ 311:45 /usr/lib/xorg/Xorg :0 -seat seat0 -auth /var/run/lightdm/root/:0 -nolisten tcp vt7 -novtswitch
    ...
    9260 pts/8    S+     0:00 /bin/bash ./build.sh
    9264 pts/8    S+     0:00 /bin/bash ./build.sh
    9269 pts/8    R+     0:00 ps a
    9270 pts/8    R+     0:00 python3 /home/mdione/local/bin/indent 4 -
    ...
    9260 pts/8    S+     0:00 /bin/bash ./build.sh
    9264 pts/8    S+     0:00 /bin/bash ./build.sh
    9271 pts/8    R+     0:00 ps g
    9272 pts/8    R+     0:00 python3 /home/mdione/local/bin/indent 4 -
    9981 pts/4    Sl     0:04 wish /usr/bin/gitk --
    11146 pts/8    Ss     0:00 -bash
    11580 pts/12   Ss+    0:00 /bin/bash
    13125 pts/11   Ss     0:00 /bin/bash
    ...
    $ ps r
    PID TTY      STAT   TIME COMMAND
    9273 pts/8    R+     0:00 ps r
    9274 pts/8    R+     0:00 python3 /home/mdione/local/bin/indent 4 -
    ...
    5567 ?        Sl    13:33 /usr/bin/konsole -session 10d0d86162000149305952800000145640011_1513284291_867598
    ...
    5691 ?        Sl    40:06 /usr/bin/kate -session 10d0d86162000150779205300000135390222_1513284291_853939
    5695 pts/0    Ss     0:00 /bin/bash
    ...
    13125 pts/11   Ss     0:00 /bin/bash
    14531 pts/6    Ss+    0:00 /bin/bash
    16788 ?        Sl    68:28 /usr/bin/firefox -P default
    ...
    9260 a8116ca0 00000000 00000000     -     - S+   pts/8      0:00 /bin/bash ./build.sh
    9264 a8116ca0 00000000 00000000     -     - S+   pts/8      0:00 /bin/bash ./build.sh
    9277 08f52b30 00000000 00000000     -     - R+   pts/8      0:00 ps X
    9278 ea71efe0 00000000 00000000     -     - R+   pts/8      0:00 python3 /home/mdione/local/bin/indent 4 -
    ...
    unconfined                       9260 pts/8    S+     0:00 /bin/bash ./build.sh
    unconfined                       9264 pts/8    S+     0:00 /bin/bash ./build.sh
    unconfined                       9279 pts/8    R+     0:00 ps Z
    unconfined                       9280 pts/8    R+     0:00 python3 /home/mdione/local/bin/indent 4 -
    ...
    11146  9260  9260 11146 pts/8     9260 S+    1000   0:00 /bin/bash ./build.sh
    9260  9264  9260 11146 pts/8     9260 S+    1000   0:00 /bin/bash ./build.sh
    9264  9281  9260 11146 pts/8     9260 R+    1000   0:00 ps j
    9264  9282  9260 11146 pts/8     9260 R+    1000   0:00 python3 /home/mdione/local/bin/indent 4 -
    5710  9981  9981  5710 pts/4     5710 Sl    1000   0:04 wish /usr/bin/gitk --
    11145 11146 11146 11146 pts/8     9260 Ss    1000   0:00 -bash
    ...
    0  1000  9260 11146  20   0  12432  3120 wait   S+   pts/8      0:00 /bin/bash ./build.sh
    1  1000  9264  9260  20   0  12444  2432 wait   S+   pts/8      0:00 /bin/bash ./build.sh
    0  1000  9283  9264  20   0  33152  1564 -      R+   pts/8      0:00 ps l
    0  1000  9284  9264  20   0  26884  6876 -      R+   pts/8      0:00 python3 /home/mdione/local/bin/indent 4 -
    ...
    1000  9260 0000000000000000 0000000000010000 0000000000000004 0000000000010002 S+   pts/8      0:00 /bin/bash ./build.sh
    1000  9264 0000000000000000 0000000000010000 0000000000000000 0000000000010002 S+   pts/8      0:00 /bin/bash ./build.sh
    1000  9285 0000000000000000 0000000000000000 0000000000000000 00000001f3d1fef9 R+   pts/8      0:00 ps s
    1000  9286 0000000000000000 0000000000000000 0000000001001000 0000000180000002 R+   pts/8      0:00 python3 /home/mdione/local/bin/indent 4 -
    ...
    mdione    9260  0.0  0.0  12432  3120 pts/8    S+   15:15   0:00 /bin/bash ./build.sh
    mdione    9264  0.0  0.0  12444  2432 pts/8    S+   15:15   0:00 /bin/bash ./build.sh
    mdione    9287  0.0  0.0  41592  3320 pts/8    R+   15:15   0:00 ps u
    mdione    9288  0.0  0.0  27276  7052 pts/8    R+   15:15   0:00 python3 /home/mdione/local/bin/indent 4 -
    ...
    9260 pts/8    S+     0:00      0  1023 11408  3120  0.0 /bin/bash ./build.sh
    9264 pts/8    S+     0:00      0  1023 11420  2432  0.0 /bin/bash ./build.sh
    9289 pts/8    R+     0:00      0   106 33045  1656  0.0 ps v
    9290 pts/8    R+     0:00      0  3836 23439  6844  0.0 python3 /home/mdione/local/bin/indent 4 -
    ...
    9260 pts/8    S+     0:00 /bin/bash ./build.sh
    9264 pts/8    S+     0:00 /bin/bash ./build.sh
    9291 pts/8    R+     0:00 ps S
    9292 pts/8    R+     0:00 python3 /home/mdione/local/bin/indent 4 -
    9981 pts/4    Sl     0:04 wish /usr/bin/gitk --
    11146 pts/8    Ss     0:52 -bash
    ...
    9260 pts/8    S+     0:00 build.sh
    9264 pts/8    S+     0:00 build.sh
    9293 pts/8    R+     0:00 ps
    9294 pts/8    R+     0:00 python3
    ...
    21636 tty2     S+     0:00 -bash
    11146 pts/8    Ss     0:00 -bash
    9260 pts/8    S+     0:00  \_ /bin/bash ./build.sh
    9264 pts/8    S+     0:00      \_ /bin/bash ./build.sh
    9297 pts/8    R+     0:00          \_ ps f
    9298 pts/8    R+     0:00          \_ python3 /home/mdione/local/bin/indent 4 -
    20854 pts/14   Ss+    0:00 /bin/bash
    5767 pts/7    Ss+    0:00 /bin/bash
    354 pts/16   Ss     0:00 /bin/bash
    ...
    9260 pts/8    S+     0:00 /bin/bash ./build.sh
    9264 pts/8    S+     0:00 /bin/bash ./build.sh
    9299 pts/8    R+     0:00 ps h
    9300 pts/8    R+     0:00 python3 /home/mdione/local/bin/indent 4 -
    9981 pts/4    Sl     0:04 wish /usr/bin/gitk --
    11146 pts/8    Ss     0:00 -bash
    11580 pts/12   Ss+    0:00 /bin/bash
    13125 pts/11   Ss     0:00 /bin/bash
    ...
    9260 pts/8    S+     0:00 /bin/bash ./build.sh
    9264 pts/8    S+     0:00 /bin/bash ./build.sh
    9301 pts/8    R+     0:00 ps n
    9302 pts/8    R+     0:00 python3 /home/mdione/local/bin/indent 4 -
    9981 pts/4    Sl     0:04 wish /usr/bin/gitk --
    11146 pts/8    Ss     0:00 -bash
    11580 pts/12   Ss+    0:00 /bin/bash
    13125 pts/11   Ss     0:00 /bin/bash
    ...
    9260 pts/8    S+     0:00 /bin/bash ./build.sh
    9264 pts/8    S+     0:00 /bin/bash ./build.sh
    9303 pts/8    R+     0:00 ps w
    9304 pts/8    R+     0:00 python3 /home/mdione/local/bin/indent 4 -
    9981 pts/4    Sl     0:04 wish /usr/bin/gitk --
    11146 pts/8    Ss     0:00 -bash
    11580 pts/12   Ss+    0:00 /bin/bash
    13125 pts/11   Ss     0:00 /bin/bash
    ...
    9260 pts/8    S+     0:00 /bin/bash ./build.sh
    9264 pts/8    S+     0:00 /bin/bash ./build.sh
    9305 pts/8    R+     0:00 ps H
    9306 pts/8    S+     0:00 python3 /home/mdione/local/bin/indent 4 -
    ...
    - -        S+     0:00 -
    9260 pts/8    -      0:00 /bin/bash ./build.sh
    - -        S+     0:00 -
    9264 pts/8    -      0:00 /bin/bash ./build.sh
    - -        S+     0:00 -
    9307 pts/8    -      0:00 ps m
    - -        R+     0:00 -
    9308 pts/8    -      0:00 python3 /home/mdione/local/bin/indent 4 -
    - -        R+     0:00 -
    ...
    859 ?        00:00:42 f2fs_gc-8:2
    886 ?        00:00:00 rpc.idmapd
    928 ?        00:00:00 kworker/2:1
    ...
    6573 ?        03:16:39 pavucontrol
    6575 ?        00:00:11 at-spi2-registr
    6703 ?        02:41:48 pulseaudio
    6706 ?        00:00:00 gconf-helper
    6708 ?        00:00:01 gconfd-2
    6727 ?        00:12:02 audacious
    6808 ?        00:00:00 kworker/u16:2
    7173 pts/5    00:00:00 mutt_compose
    7175 pts/5    00:00:00 mutt
    7201 pts/5    00:00:00 sh
    7202 pts/5    00:00:00 mcedit
    7546 ?        00:00:00 kworker/u16:0
    7756 tty3     00:00:00 agetty
    7795 tty4     00:00:00 agetty
    7808 ?        00:00:00 kworker/0:2
    8000 ?        00:12:45 firefox
    8099 ?        00:32:54 Web Content
    8166 ?        00:17:38 Web Content
    8495 ?        00:00:00 http.so
    8511 ?        00:00:00 file.so
    8531 ?        00:00:00 kworker/u16:3
    8736 ?        00:00:14 redshift
    9260 pts/8    00:00:00 build.sh
    9264 pts/8    00:00:00 build.sh
    9313 pts/8    00:00:00 ps
    9314 pts/8    00:00:00 python3
    9981 pts/4    00:00:04 wish
    10687 ?        00:01:00 kworker/3:0
    11110 ?        00:00:00 sshd
    11145 ?        00:00:00 sshd
    11146 pts/8    00:00:00 bash
    ...
    16788 ?        01:08:28 firefox
    17668 ?        00:00:03 kworker/u17:0
    17736 ?        00:00:27 kworker/0:0
    ...
    29834 ?        00:00:00 kworker/3:2
    30111 ?        00:00:00 kworker/1:1
    30218 ?        00:00:04 vboxwebsrv
    30221 ?        00:00:01 VBoxXPCOMIPCD
    30257 ?        00:00:33 VBoxSVC
    32025 ?        00:01:28 kworker/1:0
    ...
    9260 pts/8    00:00:00 build.sh
    9264 pts/8    00:00:00 build.sh
    9317 pts/8    00:00:00 ps
    9318 pts/8    00:00:00 python3
    9981 pts/4    00:00:04 wish
    21636 tty2     00:00:00 bash
    22259 pts/10   00:00:09 mutt
    32258 pts/16   00:00:00 man
    ...
    9260 pts/8    00:00:00 build.sh
    9264 pts/8    00:00:00 build.sh
    9319 pts/8    00:00:00 ps
    9320 pts/8    00:00:00 python3
    9981 pts/4    00:00:04 wish
    10687 ?        00:01:00 kworker/3:0
    11145 ?        00:00:00 sshd
    12000 ?        00:00:12 gwenview
    ...
    9260 pts/8    00:00:00 build.sh
    9264 pts/8    00:00:00 build.sh
    9321 pts/8    00:00:00 ps
    9322 pts/8    00:00:00 python3
    9981 pts/4    00:00:04 wish
    10687 ?        00:01:00 kworker/3:0
    11110 ?        00:00:00 sshd
    11145 ?        00:00:00 sshd
    ...
    mdione    9260 11146  0  3108  3120   0 15:15 pts/8    00:00:00 /bin/bash ./build.sh
    mdione    9264  9260  0  3111  2432   3 15:15 pts/8    00:00:00 /bin/bash ./build.sh
    mdione    9323  9264  0 10398  3348   0 15:15 pts/8    00:00:00 ps -F
    mdione    9324  9264  0  6819  6980   2 15:15 pts/8    00:00:00 python3 /home/mdione/local/bin/indent 4 -
    mdione   11146 11145  0  6003  6912   1 11:03 pts/8    00:00:00 -bash

    $ ps -M
    LABEL                             PID TTY          TIME CMD
    unconfined                       9260 pts/8    00:00:00 build.sh
    unconfined                       9264 pts/8    00:00:00 build.sh
    unconfined                       9325 pts/8    00:00:00 ps
    unconfined                       9326 pts/8    00:00:00 python3
    unconfined                      11146 pts/8    00:00:00 bash

    $ ps -c
    PID CLS PRI TTY          TIME CMD
    9260 TS   19 pts/8    00:00:00 build.sh
    9264 TS   19 pts/8    00:00:00 build.sh
    9327 TS   19 pts/8    00:00:00 ps
    9328 TS   19 pts/8    00:00:00 python3
    11146 TS   19 pts/8    00:00:00 bash

    $ ps -f
    UID        PID  PPID  C STIME TTY          TIME CMD
    mdione    9260 11146  0 15:15 pts/8    00:00:00 /bin/bash ./build.sh
    mdione    9264  9260  0 15:15 pts/8    00:00:00 /bin/bash ./build.sh
    mdione    9329  9264  0 15:15 pts/8    00:00:00 ps -f
    mdione    9330  9264  0 15:15 pts/8    00:00:00 python3 /home/mdione/local/bin/indent 4 -
    mdione   11146 11145  0 11:03 pts/8    00:00:00 -bash

    $ ps -j
    PID  PGID   SID TTY          TIME CMD
    9260  9260 11146 pts/8    00:00:00 build.sh
    9264  9260 11146 pts/8    00:00:00 build.sh
    9331  9260 11146 pts/8    00:00:00 ps
    9332  9260 11146 pts/8    00:00:00 python3
    11146 11146 11146 pts/8    00:00:00 bash

    $ ps -l
    F S   UID   PID  PPID  C PRI  NI ADDR SZ WCHAN  TTY          TIME CMD
    0 S  1000  9260 11146  0  80   0 -  3108 wait   pts/8    00:00:00 build.sh
    1 S  1000  9264  9260  0  80   0 -  3111 wait   pts/8    00:00:00 build.sh
    0 R  1000  9333  9264  0  80   0 -  8288 -      pts/8    00:00:00 ps
    0 R  1000  9334  9264  0  80   0 -  6721 -      pts/8    00:00:00 python3
    ...
    unconfined                       9260 pts/8    00:00:00 build.sh
    unconfined                       9264 pts/8    00:00:00 build.sh
    unconfined                       9335 pts/8    00:00:00 ps
    unconfined                       9336 pts/8    00:00:00 python3
    unconfined                      11146 pts/8    00:00:00 bash
    ...
    9260 pts/8    00:00:00   build.sh
    9264 pts/8    00:00:00     build.sh
    9337 pts/8    00:00:00       ps
    9338 pts/8    00:00:00       python3

    $ ps -w
    PID TTY          TIME CMD
    9260 pts/8    00:00:00 build.sh
    9264 pts/8    00:00:00 build.sh
    9339 pts/8    00:00:00 ps
    9340 pts/8    00:00:00 python3
    11146 pts/8    00:00:00 bash

    $ ps -L
    PID   LWP TTY          TIME CMD
    9260  9260 pts/8    00:00:00 build.sh
    9264  9264 pts/8    00:00:00 build.sh
    9341  9341 pts/8    00:00:00 ps
    9342  9342 pts/8    00:00:00 python3
    ...
    9260  9260 pts/8    00:00:00 build.sh
    9264  9264 pts/8    00:00:00 build.sh
    9343  9343 pts/8    00:00:00 ps
    9344  9344 pts/8    00:00:00 python3
    11146 11146 pts/8    00:00:00 bash
    ...
    9264 pts/8    00:00:00 build.sh
    - -        00:00:00 -
    9345 pts/8    00:00:00 ps
    - -        00:00:00 -
    9346 pts/8    00:00:00 python3
    - -        00:00:00 -
    11146 pts/8    00:00:00 bash
    - -        00:00:00 -
